  ...
  return (
    <div id="papaleta-root" data-theme="light">
      ...
      <div id="login" className="login-screen">
        <StarfieldBackground />
        <div className="login-card" style={{ background: "rgba(10,10,20,0.4)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 24, padding: "32px 20px", maxWidth: 280, width: "100%", zIndex: 2, position: "relative", boxShadow: "0 20px 40px rgba(0,0,0,0.5)", display: "flex", flexDirection: "column", gap: "12px", alignItems: "center" }}>
          
          <div style={{ textAlign: "center", fontSize: "36px", lineHeight: "1" }}>🍭🎩</div>
          <div style={{ textAlign: "center", marginBottom: "8px" }}>
            <h1 className="lc-title" style={{ fontSize: "22px", margin: "4px 0" }}>Papaleta</h1>
            <p className="lc-sub" style={{ fontSize: "12px", opacity: 0.7, margin: 0 }}>Tu laboratorio de ideas con IA</p>
          </div>

          <div style={{ width: "36px", height: "36px", borderRadius: "50%", border: "1px solid rgba(255,255,255,0.2)", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.05)", marginBottom: "4px" }}>
          ...
          <div className="lc-features" style={{ display: "flex", flexDirection: "column", gap: "6px", width: "100%" }}>
            <div className="lcf" style={{ padding: "6px 10px", fontSize: "11px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", width: "100%" }}>🔍 Analiza inteligente</div>
            <div className="lcf" style={{ padding: "6px 10px", fontSize: "11px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", width: "100%" }}>✨ Potencia con IA</div>
            <div className="lcf" style={{ padding: "6px 10px", fontSize: "11px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", width: "100%" }}>📁 Kanban interactivo</div>
            <div className="lcf" style={{ padding: "6px 10px", fontSize: "11px", background: "rgba(255,255,255,0.03)", borderRadius: "8px", width: "100%" }}>🎞️ Visual de avances</div>
          </div>

          <button id="btn-login" className="btn-google" style={{ width: "100%", padding: "8px", fontSize: "12px", background: "rgba(255,255,255,0.05)", color: "white", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", display: "flex", justifyContent: "center", alignItems: "center", gap: "8px", cursor: "pointer" }}>
            <svg width="14" height="14" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.07 5.07 0 01-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" /><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" /><path fill="#FBBC05" d="M5.84 14.09a6.97 6.97 0 010-4.18V7.07H2.18A11 11 0 001 12c0 1.78.43 3.45 1.18 4.93l3.66-2.84z" /><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" /></svg>
            G Continuar
          </button>
          ...
          <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "8px" }}>
            <div style={{ position: "relative" }}>
              ...
              <input type="text" placeholder="Username" style={{ width: "100%", padding: "8px 10px 8px 30px", background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", color: "white", fontSize: "12px", outline: "none" }} />
            </div>
            <div style={{ position: "relative" }}>
              <span style={{ position: "absolute", left: "10px", top: "50%", transform: "translateY(-50%)", fontSize: "12px", opacity: 0.6 }}>🔒</span>
              <input type="password" placeholder="***********" style={{ width: "100%", padding: "8px 10px 8px 30px", background: "rgba(0,0,0,0.3)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "8px", color: "white", fontSize: "12px", outline: "none" }} />
            </div>
          </div>

          <div style={{ display: "flex", justifyContent: "space-between", width: "100%", fontSize: "10px", color: "rgba(255,255,255,0.6)", marginTop: "-2px" }}>
            <label style={{ display: "flex", alignItems: "center", gap: "4px", cursor: "pointer" }}><input type="checkbox" style={{ accentColor: "#FF6B00" }} /> ✅ Remember me</label>
            <a href="#" style={{ color: "rgba(255,255,255,0.6)", textDecoration: "none" }}>Forgot Password?</a>
          </div>

          <button id="btn-local" className="btn-local" style={{ background: "#FF6B00", color: "white", width: "100%", border: "none", padding: "10px", borderRadius: "8px", fontWeight: "700", fontSize: "13px", cursor: "pointer", transition: "transform 0.2s", marginTop: "4px" }} onMouseOver={(e)=>e.currentTarget.style.transform="scale(1.02)"} onMouseOut={(e)=>e.currentTarget.style.transform="scale(1)"}>LOGIN</button>
          
          <p className="lc-note" style={{ fontSize: "10px", opacity: 0.5, margin: 0 }}>Gratis &middot; Sin tarjeta &middot; Privado</p>
        </div>
      </div>
